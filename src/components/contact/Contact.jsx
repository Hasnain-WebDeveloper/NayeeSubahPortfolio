        ...
        <div className="contact-left">
          ...
          <div className="contact-item">
            ...
            <div className="contact-details">
              <a href="mailto:easyaplus111@gmail.com">easyaplus111@gmail.com</a>
          ...
          <div className="contact-item">
            ...
            <div className="contact-details">
              <a href="https://wa.me/+923117859563" target="_blank" rel="noopener noreferrer">+92 311 7859563</a>
              <p>Write me <FaArrowRight className="arrow-icon" /></p>
            </div>
          </div>
          <div className="contact-item">
            ...
            <div className="contact-details">
              <a href="https://m.me/razahussainkandhro" target="_blank" rel="noopener noreferrer">Hasnain Ali Kandhro</a>
              <p>Write me <FaArrowRight className="arrow-icon" /></p>
            </div>
          </div>
        </div>
